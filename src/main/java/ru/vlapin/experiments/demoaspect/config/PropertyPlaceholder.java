...
import ru.vlapin.experiments.demoaspect.model.JavaConfigBasedSetterPropertiesPlaceholderExample;
...
@Slf4j
@Configuration
@ConfigurationPropertiesScan("ru.vlapin.experiments.demoaspect")
